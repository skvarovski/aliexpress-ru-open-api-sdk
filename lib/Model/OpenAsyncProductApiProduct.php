...
class OpenAsyncProductApiProduct implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    protected static array $openAPINullables = [
        'language' => false,
		'product_unit' => false,
		'multi_language_description_list' => false,
		'multi_language_subject_list' => false,
		'aliexpress_category_id' => false,
		'brand_name' => false,
		'main_image_urls_list' => false,
		'sku_info_list' => false,
		'attribute_list' => false,
		'inventory_deduction_strategy' => false,
		'weight' => false,
		...
		'size_chart_id' => false,
		'shipping_lead_time' => false,
		'service_policy_id' => false,
		'ae_group_ids' => false,
		'package_type' => false,
		'lot_num' => false,
		'gtin' => false,
    ...
    public function __construct(array $data = null)
    {
        ...
        $this->setIfExists('multi_language_description_list', $data ?? [], null);
        $this->setIfExists('multi_language_subject_list', $data ?? [], null);
        $this->setIfExists('aliexpress_category_id', $data ?? [], null);
        $this->setIfExists('brand_name', $data ?? [], null);
        $this->setIfExists('main_image_urls_list', $data ?? [], null);
        $this->setIfExists('sku_info_list', $data ?? [], null);
        $this->setIfExists('attribute_list', $data ?? [], null);
        $this->setIfExists('inventory_deduction_strategy', $data ?? [], null);
        ...
        $this->setIfExists('size_chart_id', $data ?? [], null);
        $this->setIfExists('shipping_lead_time', $data ?? [], null);
        $this->setIfExists('service_policy_id', $data ?? [], null);
        $this->setIfExists('ae_group_ids', $data ?? [], null);
    ...
    */
    ...
    public function setMultiLanguageDescriptionList($multi_language_description_list)
    {
        ...
        if (is_null($multi_language_description_list)) {
            throw new \InvalidArgumentException('non-nullable multi_language_description_list cannot be null');
        }
    ...
    public function setMultiLanguageSubjectList($multi_language_subject_list)
    {
        ...
        if (is_null($multi_language_subject_list)) {
            throw new \InvalidArgumentException('non-nullable multi_language_subject_list cannot be null');
        }
    ...
    public function setAliexpressCategoryId($aliexpress_category_id)
    {
        ...
        if (is_null($aliexpress_category_id)) {
            throw new \InvalidArgumentException('non-nullable aliexpress_category_id cannot be null');
        }
    ...
    public function setMainImageUrlsList($main_image_urls_list)
    {
        ...
        if (is_null($main_image_urls_list)) {
            throw new \InvalidArgumentException('non-nullable main_image_urls_list cannot be null');
        }
    ...
    public function setAttributeList($attribute_list)
    {
        ...
        if (is_null($attribute_list)) {
            throw new \InvalidArgumentException('non-nullable attribute_list cannot be null');
        }
    ...
    public function setInventoryDeductionStrategy($inventory_deduction_strategy)
    {
        ...
        if (is_null($inventory_deduction_strategy)) {
            throw new \InvalidArgumentException('non-nullable inventory_deduction_strategy cannot be null');
        }
    ...
    public function setSizeChartId($size_chart_id)
    {
        ...
        if (is_null($size_chart_id)) {
            throw new \InvalidArgumentException('non-nullable size_chart_id cannot be null');
        }
    ...
    public function setShippingLeadTime($shipping_lead_time)
    {
        ...
        if (is_null($shipping_lead_time)) {
            throw new \InvalidArgumentException('non-nullable shipping_lead_time cannot be null');
        }
    ...
    public function setServicePolicyId($service_policy_id)
    {
        ...
        if (is_null($service_policy_id)) {
            throw new \InvalidArgumentException('non-nullable service_policy_id cannot be null');
        }
    ...
    public function setAeGroupIds($ae_group_ids)
    {
        ...
        if (is_null($ae_group_ids)) {
            throw new \InvalidArgumentException('non-nullable ae_group_ids cannot be null');
        }
