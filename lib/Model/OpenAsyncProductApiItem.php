...
class OpenAsyncProductApiItem implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    public function __construct(array $data = null)
    {
        ...
        $this->setIfExists('old_price_range', $data ?? [], null);
        $this->setIfExists('stock', $data ?? [], null);
        $this->setIfExists('shipping_template', $data ?? [], null);
        $this->setIfExists('decline_reason', $data ?? [], null);
        $this->setIfExists('offline_at', $data ?? [], null);
    ...
    */
    ...
    public function setOldPriceRange($old_price_range)
    {
        ...
        if (is_null($old_price_range)) {
            throw new \InvalidArgumentException('non-nullable old_price_range cannot be null');
        }
    ...
    public function setShippingTemplate($shipping_template)
    {
        ...
        if (is_null($shipping_template)) {
            throw new \InvalidArgumentException('non-nullable shipping_template cannot be null');
        }
    ...
    public function setOfflineAt($offline_at)
    {
        ...
        if (is_null($offline_at)) {
            throw new \InvalidArgumentException('non-nullable offline_at cannot be null');
        }
