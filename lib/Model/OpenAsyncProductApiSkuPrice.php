...
/**
 * OpenAsyncProductApiSkuPrice Class Doc Comment
 *
 * @category Class
 * @package  OpenAPI\Client
 * @author   OpenAPI Generator team
 ...
 */
class OpenAsyncProductApiSkuPrice implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'open_async_product_apiSkuPrice';
     ...
     * Sets sku_code
     *
     * @param string|null $sku_code Идентификатор экземпляра: артикул или штрихкод
     *
     * @return self
     */
     ...
     * Sets price
     *
     * @param string|null $price Цена товара от 0,01 до 999999
     *
     * @return self
     */
     ...
     * Sets discount_price
     *
     * @param string|null $discount_price Цена товара со скидкой
     *
     * @return self
     */
