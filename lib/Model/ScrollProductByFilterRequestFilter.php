...
class ScrollProductByFilterRequestFilter implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    protected static array $openAPINullables = [
        'top_category_ids' => false,
		'leaf_category_ids' => false,
		'owner_id' => false,
		'shipping_template_ids' => false,
		'status' => false,
		'group_ids' => false,
		'has_quantity' => false,
		'search_content' => false,
		'time_range_condition' => false,
		'offline_reason' => false
    ];
    ...
    {
        $this->setIfExists('top_category_ids', $data ?? [], null);
        $this->setIfExists('leaf_category_ids', $data ?? [], null);
        $this->setIfExists('owner_id', $data ?? [], null);
        $this->setIfExists('shipping_template_ids', $data ?? [], null);
        ...
        $this->setIfExists('time_range_condition', $data ?? [], null);
        $this->setIfExists('offline_reason', $data ?? [], null);
    }
    ...
    */
    ...
    public function setTopCategoryIds($top_category_ids)
    {
        ...
        if (is_null($top_category_ids)) {
            throw new \InvalidArgumentException('non-nullable top_category_ids cannot be null');
        }
    ...
    public function setShippingTemplateIds($shipping_template_ids)
    {
        ...
        if (is_null($shipping_template_ids)) {
            throw new \InvalidArgumentException('non-nullable shipping_template_ids cannot be null');
        }
    ...
    public function setTimeRangeCondition($time_range_condition)
    {
        ...
        if (is_null($time_range_condition)) {
            throw new \InvalidArgumentException('non-nullable time_range_condition cannot be null');
        }
    ...
    public function setOfflineReason($offline_reason)
    {
        ...
        if (is_null($offline_reason)) {
            throw new \InvalidArgumentException('non-nullable offline_reason cannot be null');
        }
